...
label_lista_obiektow.grid(row=1, column=1)

listbox_lista_obiektow = Listbox(ramka_lista_obiektow)
listbox_lista_obiektow.grid(row=2, column=1, columnspan=3)
...
map_widget = tkintermapview.TkinterMapView(ramka_mapa, width=1200, heigh=600)
